...
/// Loads real Home Screen icons via a private UIKit call, with a cache so the
/// process list doesn't re-render them while scrolling. Returns nil if the API
/// is unavailable or the app has no icon — callers fall back to a glyph.
enum AppIcon {
