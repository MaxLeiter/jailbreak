...
export default function Try() {
  return (
    <>
        ...
        <dl className="deflist">
          <div className="row">
            ...
            <dd>
              ...
              target. Rootless only: every binary bakes in <code>/var/jb</code>,
              so a rooted jailbreak cannot run this.
            </dd>
          </div>
          <div className="row">
      ...
      <Section num="07.4" title="Launch it">
        <div className="prose">
          <p>
            ...
            session. From there, gestures drive it: a three-finger tap switches
            between running displays, a four-finger tap opens the session and
            dimension picker, a pinch zooms to fit, and a swipe up from the lower
      ...
      <Section num="07.5" title="When it does not come up">
        <dl className="deflist">
          <div className="row">
      ...
      <Section num="07.6" title="Send feedback">
        <div className="prose">
          <p>
