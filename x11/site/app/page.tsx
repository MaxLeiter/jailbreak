    ...
    <>
      <header className="page-header">
        ...
        <p className="lede">
          ...
          on machines that shouldn&apos;t run it. A few years ago, I
          painstakingly{" "}
          <Ext href="https://maxleiter.com/x11">ported X11 to iOS</Ext>. The server
          ran on-device, but you had to connect with a VNC client. With tokens and
          time, that need is no more.
        </p>
      </header>
      ...
      <Section num="00.1" title="Where this came from">
        <div className="prose">
          ...
          <p>
            ...
            device. When I inevitably revisited it a year later, the right move
            was a build system. Thankfully the{" "}
          ...
          <p>
            ...
            the packages target rootless jailbroken iOS more broadly.
          </p>
        </div>
      </Section>
