...
- **KDE/KF6 has KWin first-light, QtWayland/ANGLE IOSurface smoke, and packaged `plasma-workspace`/`plasmashell`.** Next gate is `plasma-desktop` containment/applets plus a desktop launcher around the KWin + Plasma Workspace base.
