...
TABLE = [
    ...
    dict(t="kio", kind="kf", deb="kf6-kio", rev="ios3",
    ...
    dict(t="plasma-activities", kind="plasma", deb="plasma-activities", deps=[],
         ...
         notes=["Slim in Plasma 6 (Qt Core+DBus only; the old boost dependency is gone -",
                "audited). libplasma REQUIREs it. Correction (2026-07-08): the",
                "kactivitymanagerd daemon IS built in this stack, as a hand-maintained",
                "sibling recipe outside this table (recipes/kactivitymanagerd.mk +",
                "recipes/kactivitymanagerd-ios-fixes.sh, built via the Workspace-layer",
                "driver, not build-kf6.sh's TARGETS), so activity state is live over the",
                "real DBus service rather than staying static."]),
