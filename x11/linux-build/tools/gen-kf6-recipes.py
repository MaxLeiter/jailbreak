...
TABLE = [
    ...
    dict(t="qqc2-desktop-style", kind="kf", deb="kf6-qqc2-desktop-style",
         ...
         rev="ios2",
         pkg_lines=["bash /work/recipes/qqc2-desktop-style-ios-qml-stubs.sh $(BUILD_DIST)/kf6-qqc2-desktop-style"],
         ...
         notes=["Runtime dependency for Plasma Desktop shell error delegates and desktop QML.",
                ...
                "loads when the upstream desktop shell is selected. The iOS package applies",
                "narrow QML shims for startup-hostile controls and the private text context",
                "menu singleton, whose upstream self-import path creates a QQC2 type cycle."]),
