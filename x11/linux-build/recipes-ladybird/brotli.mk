...
# brotli.mk — Ladybird leaf closure. REUSE upstream 1.1.0 (feeds woff2 + curl). Identical to
# upstream Procursus recipe apart from the +ios1 deb marker (AGENTS convention).
