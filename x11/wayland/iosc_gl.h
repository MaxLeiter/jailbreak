 ...
 * free of GL headers. Callers fail closed if initialization fails.
 */
#ifndef IOSC_GL_H
#define IOSC_GL_H
...
/* End the frame and enqueue its cross-process MTLSharedEvent signal without
 * waiting on the producer CPU. */
 ...
 * wait before sampling; 0 is fatal. */
