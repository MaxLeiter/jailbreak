 ...
 * requires a BIND with window_id=XIOS_PROTOCOL_VERSION, followed by an exact-v1
 * HELLO using that same field, before any WINDOW_* records. Every NATIVE_FRAME carries a brokered GPU
