...
stroke(od, TL, BR, int(SS * 0.082), (18, 82, 180, 230))
stroke(od, TR, BL, int(SS * 0.082), (18, 103, 190, 230))
stroke(od, TL, BR, int(SS * 0.045), HILITE + (250,))
stroke(od, TR, BL, int(SS * 0.045), (185, 255, 255, 250))
stroke(od, (SS * 0.37, SS * 0.37), (SS * 0.63, SS * 0.63), int(SS * 0.030), (255, 255, 255, 90))
img.paste(ov, (0, 0), ov)
